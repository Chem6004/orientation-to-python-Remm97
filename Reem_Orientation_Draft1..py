...
plt.figure(2)
plt.title('Time to Calculate T vs. N')
plt.xlabel('Number of Particles')
plt.ylabel('Time (s)')
plt.plot(x, z, 'orange')
...
print("Printing array of Npart", x1)
print("Printing array of PE vs N", y1)

plt.figure(3)
plt.title('Potential Energy (V) vs. N')
plt.xlabel('Number of Particles')
plt.ylabel('Total Potential Energy (V)')
...
plt.figure(4)
plt.title('Time to Calculate V vs. N')
plt.xlabel('Number of Particles')
plt.ylabel('Time (s)')
plt.plot(x1, w, 'black')